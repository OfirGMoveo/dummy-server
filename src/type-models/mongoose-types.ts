import { ReMap } from './helpers-types';
import { SchemaTypeOpts, Schema, SchemaType, SchemaOptions }  from 'mongoose';



export type StrongSchema<M> =  ReMap<M, (SchemaTypeOpts<any> | Schema | SchemaType) & {ref: string}>; //{ [key in keyof M]: (SchemaTypeOpts<any> | Schema | SchemaType) & {ref: string} }
